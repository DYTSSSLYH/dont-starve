...
namespace DYT
{
    public class MainSelf : MonoBehaviour
    {
        ...
        public static Dictionary<int, EntityScript> Ents = new Dictionary<int, EntityScript>();
        ...
        public static Dictionary<int, EntityScriptSelf> NewWallUpdatingEnts = new();
        public static int num_updating_ents = 0;
        public static int NumEnts = 0;
    
    
        public static EntityScriptSelf TheGlobalInstance = null;
