...
namespace DYT.Map
{
    ...
    public abstract class Customise
    {
        protected List<SpinnerOption> freqency_descriptions;
        protected List<SpinnerOption> freqency_descriptions_ps4_exceptions;
        ...
        protected List<SpinnerOption> size_descriptions;
        //-- TODO: Read this from the tasks.lua
        protected List<SpinnerOption> yesno_descriptions;
        ...
        protected Customise()
        {
            ...
            yesno_descriptions = new List<SpinnerOption>
            {
	            new() { text = STRINGS.UI.SANDBOXMENU.YES, data = "default" },
	            new() { text = STRINGS.UI.SANDBOXMENU.NO, data = "never" },
            };
            ...
            GROUP = new Dictionary<string, CustomiseGroup>
            {
	            ["monsters"] =
	            {
		            ...
		            items =
		            {
			            ...
			            ["antman"] =
				            { value = "default", enable = false, spinner = null, image = "mants.tex", order = 2 },
			            ["giantgrub"] =
				            { value = "default", enable = false, spinner = null, image = "giant_grubs.tex", order = 3 },
			            ["frog_poison"] =
			            {
				            value = "default", enable = false, spinner = null, image = "poison_dart_frogs.tex",
				            order = 4
			            },
			            ["mosquito"] =
			            ...
			            ["snake"] =
			            {
				            value = "default", enable = false, spinner = null, image = "snakes.tex", order = 10
			            },
			            ["scorpion"] =
			            ...
			            ["roc"] =
			            {
				            value = "default", enable = false, spinner = null, image = "roc.tex",
	            ...
	            ["resources"] =
	            {
		            ...
		            items =
		            {
			            ...
			            ["reeds"] =
			            {
				            value = "default", enable = false, spinner = null, image = "reeds.tex", order = 6
			            },
			            ["rainforesttree"] =
			            {
			            ...
			            ["lotus"] =
			            {
				            value = "default", enable = false, spinner = null, image = "lotus.tex", order = 15
			            },
			            ["nettle"] =
	            ...
	            ["unprepared"] =
	            {
		            ...
		            items =
		            {
			            ...
			            ["radish"] =
				            { value = "default", enable = true, spinner = null, image = "radish.tex", order = 3 },
			            ["mushroom"] =
	            ...
	            ["misc"] =
	            {
		            ...
		            items =
		            {
			            ...
			            ["day"] =
			            {
				            value = "default", enable = false, spinner = null, image = "day.tex",
				            desc = day_descriptions,
				            order = 6
			            },
			            ["weather"] =
			            {
			            ...
			            ["fog"] =
			            {
				            value = "default", enable = false, spinner = null, image = "fog.tex",
				            desc = yesno_descriptions,
				            order = 9
			            },
			            ["brambles"] =
        ...
        /// 获得指定item键所属的group键
        /// </summary>
        /// <param name="target">Dictionary&lt;string, CustomiseItem&gt; items中的键</param>
        /// <returns></returns>
        public string GetGroupForItem(string target)
        {
	        foreach ((string area, CustomiseGroup customiseGroup) in GROUP)
	        {
		        foreach ((string name, CustomiseItem customiseItem) in customiseGroup.items)
			        if (name == target) return area;
	        }
