...
{
    public class ShipwreckedLevels
    {
        static ShipwreckedLevels()
        {
			...
			Levels.AddLevel(LEVELTYPE.SHIPWRECKED, new Level
			{
				...
				overrides =
				{
					...
					}, //--You start in a setpiece, this one is a grass patch with flowers. 
					{
						"start_node", "BeachSand"
					}, //--This is the room (biome) you start in 'BeachSand' comes from terrain_beach.lua
					...
					{
						"world_size", "default"
					}, //--World size: tiny, small, default, medium, large, or huge. Actual values are in map/forest_map.lua approx line 270
					//--{"mild_season",		20},
					//--{"wet_season",		16},
					//--{"green_season",	21},
					//--{"dry_season",		16},
				...
				selectedtasks = new List<Level.SelectedTask>
				{
					new()
					{
						//-- RING NONE
...
//-- ===================================================================================================================================================
				...
				background_node_range = new[] { 0, 2 },

				water_content =
				{
					["WaterAll"] = { checkFn = (ground) => WorldSim.IsWater(ground) && !WorldSim.IsShore(ground) },
					["WaterShallow"] = { checkFn = (ground) => ground == Constant.GROUND.OCEAN_SHALLOW },
					["WaterMedium"] = { checkFn = (ground) => ground == Constant.GROUND.OCEAN_MEDIUM },
					["WaterDeep"] = { checkFn = (ground) => ground == Constant.GROUND.OCEAN_DEEP },
					["WaterCoral"] = { checkFn = (ground) => ground == Constant.GROUND.OCEAN_CORAL },
					//--["WaterMangrove"] = {checkFn = (ground)=>ground == GROUND.MANGROVE },
					["WaterShipGraveyard"] = { checkFn = (ground) => ground == Constant.GROUND.OCEAN_SHIPGRAVEYARD },
				},
				...
				set_pieces =
				{
					["ResurrectionStoneSw"] =
					{
						...
						tasks =
						{
							"IslandParadise", "VerdantMost", "AllBeige", "NoGreen B", "Florida Timeshare",
							"PiggyParadise", "JungleDRockyland", "JungleDRockyMarsh", "JungleDSavRock",
							"IslandJungleRockyDrop",
						}
					},
				...
				treasures =
				{
					["TestTreasure"] =
					{
						count = 1, treasuretasks = { "DesertIsland" }, maptasks = { "IslandParadise" },
						tasks = { "IslandParadise" }
					},
				},
