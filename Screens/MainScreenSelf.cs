...
namespace Screens
{
    public class MainScreenSelf : ScreenSelf
    {
        ...
        private void Start()
        {
            ...
            menu.Find("Options").GetComponent<Button>().onClick.AddListener(() =>
            {
                ...
                optionMenu.Find("MoreGames").GetComponent<Button>().onClick.AddListener(() =>
                    MainSelf.VisitURL("http://store.steampowered.com/search/?developer=Klei%20Entertainment")
                );
        ...
        public static MainScreenSelf Mainscreen = null;

        public MainScreenSelf(PlayerProfile profile)
        {
            // this("MainScreen");
        }
    }
