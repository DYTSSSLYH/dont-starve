...
public class Constant
{
    ...
    public static List<string> BACKEND_PREFABS = new List<string>
    {
    ...
    public static List<string> RECIPE_PREFABS = new List<string>();
    
    public static List<String> MAIN_CHARACTER_LIST = new List<string>
    {
        "wilson",
        "willow",
        "wolfgang",
    ...
    public static List<String> ROG_CHARACTER_LIST = new List<string>
    {
        "wathgrithr",
        "webber"
    };
    
    public static List<String> SHIPWRECKED_CHARACTER_LIST = new List<string>
    {
        "walani"
    };
    
    // REMEMBER THE CONSTANT FILES IN THE OTHER DLCs TOO!!
    public static List<String> PORKLAND_CHARACTER_LIST = new List<string>
    {
        "warbucks",
        "wilba",
        "wormwood"
    ...
    public static List<String> RETIRED_CHARACTER_LIST = new List<string>
    {
        "warbucks"
    };
    ...
    public static List<String> MOD_CHARACTER_LIST = new List<string>();
    ...
    {
        public static RecipeTab TOOLS = new RecipeTab("TOOLS", 0, "tab_tool");
        public static RecipeTab LIGHT = new RecipeTab("LIGHT", 1, "tab_light");
        public static RecipeTab ARCHAEOLOGY = new RecipeTab("ARCHAEOLOGY", 2, "tab_archaeology");
        public static RecipeTab SURVIVAL = new RecipeTab("SURVIVAL", 3, "tab_trap");
        public static RecipeTab NAUTICAL = new RecipeTab("NAUTICAL", 4, "tab_nautical");
        public static RecipeTab FARM = new RecipeTab("FARM", 5, "tab_farm");
        public static RecipeTab SCIENCE = new RecipeTab("SCIENCE", 6, "tab_science");
        public static RecipeTab WAR = new RecipeTab("WAR", 7, "tab_fight");
        public static RecipeTab TOWN = new RecipeTab("TOWN", 8, "tab_build");
        public static RecipeTab REFINE = new RecipeTab("REFINE", 9, "tab_refine");
        public static RecipeTab MAGIC = new RecipeTab("MAGIC", 10, "tab_arcane");
        public static RecipeTab DRESS = new RecipeTab("DRESS", 11, "tab_dress");
        ...
        public static RecipeTab CRAFTINGSTATIONS = new RecipeTab("CRAFTINGSTATIONS", 12, "tab_crafting"),
            HOME = new RecipeTab
            {
    ...
    public class RENO_RECIPETABS
    {
        public static RecipeTab
            DOORS = new RecipeTab { str = "DOORS", sort = 13, icon = "reno_doors_plate.tex", isReno = true },
            HOME_KITS = new RecipeTab { str = "HOME KITS", sort = 14, icon = "reno_tab_homekits.tex", isReno = true },
            CHAIRS = new RecipeTab { str = "CHAIRS", sort = 15, icon = "reno_tab_chairs.tex", isReno = true },
            SHELVES = new RecipeTab { str = "SHELVES", sort = 16, icon = "reno_tab_shelves.tex", isReno = true },
            RUGS = new RecipeTab { str = "RUGS", sort = 17, icon = "reno_tab_rugs.tex", isReno = true },
            LAMPS = new RecipeTab { str = "LAMPS", sort = 18, icon = "reno_tab_lamps.tex", isReno = true },
            PLANT_HOLDERS = new RecipeTab
                { str = "PLANT HOLDERS", sort = 19, icon = "reno_tab_plantholders.tex", isReno = true },
            TABLES = new RecipeTab { str = "TABLES", sort = 20, icon = "reno_tab_tables.tex", isReno = true },
            ORNAMENTS = new RecipeTab { str = "ORNAMENTS", sort = 21, icon = "reno_tab_ornaments.tex", isReno = true },
            WINDOWS = new RecipeTab { str = "WINDOWS", sort = 22, icon = "reno_tab_windows.tex", isReno = true },
            COLUMNS = new RecipeTab { str = "COLUMNS", sort = 23, icon = "reno_tab_columns.tex", isReno = true },
            FLOORING = new RecipeTab { str = "FLOORING", sort = 24, icon = "reno_tab_floors.tex", isReno = true },
            WALLPAPER = new RecipeTab { str = "WALL PAPER", sort = 25, icon = "reno_tab_wallpaper.tex", isReno = true },
            HANGING_LAMPS = new RecipeTab
                { str = "HANGING LAMPS", sort = 26, icon = "reno_tab_hanginglamps.tex", isReno = true };
    }
    ...
    {
        public static Tech
            NONE = new Tech { SCIENCE = 0, MAGIC = 0, ANCIENT = 0, OBSIDIAN = 0, LOST = 0 },
            SCIENCE_ONE = new Tech { SCIENCE = 1 },
            SCIENCE_TWO = new Tech { SCIENCE = 2 },
            SCIENCE_THREE = new Tech { SCIENCE = 3 },
            // Magic starts at level 2 so it's not teased from the start.
            MAGIC_TWO = new Tech { MAGIC = 2 },
            MAGIC_THREE = new Tech { MAGIC = 3 },
            ANCIENT_TWO = new Tech { ANCIENT = 2 },
            ANCIENT_THREE = new Tech { ANCIENT = 3 },
            ANCIENT_FOUR = new Tech { ANCIENT = 4 },
            OBSIDIAN_TWO = new Tech { OBSIDIAN = 2 },
            HOME_TWO = new Tech { HOME = 2 },
            CITY = new Tech { CITY = 2 },

            LOST = new Tech { LOST = 10 };
    }
    ...
    {
	    public static List<string> MAIN_GAME = new List<string>
	    {
		    "loading_wagstaff",
		    "loading_maxwell",
		    "loading_newhorizons",
	    ...
	    public static List<List<string>> DLCS = new List<List<string>>
	    {
		    new List<string> //RoG
		    {
			    "loading_webber",
